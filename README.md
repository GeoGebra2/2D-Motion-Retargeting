...
`python scripts/ntu_batch_retarget_single_target.py --ntu_root dataset/nturgb+d_skeletons --model_path model/pretrained_skeleton.pth --target_person 005 --out_root outputs/ntu-single-P005 --height 720 --width 1280 --max_length 120`
