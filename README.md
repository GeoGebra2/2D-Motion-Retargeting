...
NTU扩展批量处理脚本
`python scripts/ntu_batch_retarget_single_target.py --ntu_root dataset/nturgb+d_skeletons --model_path model/pretrained_skeleton.pth --out_root outputs/ntu-single-auto --height 720 --width 1280 --max_length 120 --desired_sources 20 --min_per_source 100 --max_per_source 1000 --min_per_camera 20`
